...
if ( ! function_exists( 'flatsome_wishlist_integrations_scripts' ) ) {
	...
	function flatsome_wishlist_integrations_scripts() {
		...
		wp_enqueue_script( 'flatsome-woocommerce-wishlist',  $integrations_uri . '/wc-yith-wishlist/wishlist.js', array( 'jquery', 'flatsome-js' ), '3.10.1', true );
		wp_enqueue_style( 'flatsome-woocommerce-wishlist', $integrations_uri . '/wc-yith-wishlist/wishlist.css', 'flatsome-woocommerce-style', '3.10.1' );
	}
}
