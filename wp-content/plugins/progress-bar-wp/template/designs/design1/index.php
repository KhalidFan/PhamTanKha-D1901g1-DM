...
<?php require('mystyle.php'); ?>
	<?php
			...
			switch($pb_layout){
				...
				<div class="col-md-<?php echo $pb_layout; ?> col-sm-6 indCol">
                   
                <div class="wpsm_progress">
                <div class="wpsm_progress-pro-bar">
                    <span class="wpsm_progress-title">
                        <?php echo $progress_title; ?>
                        <span class="wpsm_progress-value"><?php echo $progress_size;?>%</span>
                    </span>
                    <span class="wpsm_progress-bar wow" style="width:<?php echo $progress_size;?>%;"></span>
                </div>
            </div>
